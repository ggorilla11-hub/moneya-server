...
→ update_smart_note(note_page=2, title="경제적고민", fields={"w1":"실제고민내용","goal":"해결목표"})`,
  ...
  3: `[지금 할 것: 수입지출 분석 — 생활비 절대 먼저 묻지 않는다]

예고: "지금까지 고민을 들었고, 이제 수입과 지출을 함께 정리해 보겠습니다."
① "현재 세후 한 달 실수령액이 어떻게 되세요?"
→ 즉시: update_smart_note(note_page=3, title="수입지출", fields={"income":"금액"})
② "대출 원리금 상환 중인 것이 있으신가요?"
...
→ update_smart_note(note_page=6, title="저축투자", fields={"net":"순투자재원"})`,
...
→ update_smart_note(note_page=7, title="자산배분", fields={"res":"부동산비중","inv":"금융비중"})`,
...
→ update_smart_note(note_page=8, sub_page=6, title="부동산설계", fields={"strategy":"전략"})`,
