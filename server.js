...
### 핵심 규칙
금액을 말할 때는 반드시 이 형식을 사용하세요:
**"숫자원(한글발음)"** 형식 - 괄호 안에 한글!

### 올바른 응답 예시 (반드시 이 형식으로!)
- "오늘 남은 예산은 34,964원(삼만사천구백육십사원)입니다."
- "점심 예산으로 15,000원(만오천원) 사용하실 수 있어요."
- "이번 주 남은 예산은 192,000원(십구만이천원)이에요."
- "커피값 8,000원(팔천원) 정도는 괜찮아요."

### 발음 규칙 (괄호 안 한글)
- 35,207원 → 35,207원(삼만오천이백칠원)
- 192,000원 → 192,000원(십구만이천원)
- 66,667원 → 66,667원(육만육천육백육십칠원)
- 15,000원 → 15,000원(만오천원)
- 8,000원 → 8,000원(팔천원)

### 절대 하지 말아야 할 것
- "34,964원입니다" ← 괄호 발음 없이 숫자만 쓰면 안됨!
- "삼만사천구백육십사원입니다" ← 숫자 없이 한글만 쓰면 안됨!
- "34,964원, 삼만사천구백육십사원" ← 쉼표 말고 괄호 사용!
- 반드시 "숫자원(한글발음)" 형식을 지키세요!
