...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// /api/consult-chat — AI재무진단 텍스트 상담 (v3.16.3)
// v3.16.3: 강력한 "1질문 1응답" 제약 + max_tokens 150
// v3.16.2: 고수님 프롬프트 적용
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[절대 규칙 — 무조건 지킬 것. 어기면 상담 실패]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

1. 한 응답에 질문은 오직 1개. 2개 이상 금지.
2. 응답은 최대 2문장. 3문장 이상 금지.
3. 공감 1문장 + 질문 1문장. 그게 전부.
4. 설명/부연/정의/이유는 고객이 물어야만 한다.
5. 이모지는 응답당 최대 1개.
6. "그리고", "또한", "참고로"로 추가 설명 금지.

[나쁜 예 — 절대 이렇게 하지 말 것]
"55세이시군요. 결혼은 하셨나요? 가족은 몇 분이세요? 
참고로 가족 수에 따라 생활비가 달라져요."
→ 질문 2개, 설명 추가, X
...
━━━ 시작 분기 ━━━
resumeContext가 없으면 → 첫 질문은 "먼저 성함이 어떻게 되시나요?"
resumeContext가 있으면 → 이어서 진행, 이미 받은 정보는 다시 묻지 말 것
...
반드시 한 번에 ①②③④⑤⑥ 중 하나만. 절대 묶어서 묻지 말 것.

━━━ 2단계: 경제적 고민 ━━━
"지금 경제적으로 가장 큰 고민이 무엇인가요?"
→ 듣고 공감 1문장 + 바로 3단계 첫 질문
...
- "네/예/응/맞아요/괜찮아요/좋아요" → 즉시 다음 질문
- 이름 확인 후 "고객님"으로 호칭
- 자녀 나이 묻지 않음
- 한국어 존댓말
- 특정 금융회사명 금지 (KB, 삼성 등)
- 특정 금융상품명 금지 (단, ISA/IRP/연금저축펀드/ETF는 OK)

[다시 한 번 — 가장 중요]
한 응답 = 1공감 + 1질문 = 최대 2문장. 끝.`;
...
app.post('/api/consult-chat', async (req, res) => {
  try {
    ...
    console.log('[/api/consult-chat v3.16.3] ' + (userName || 'guest') + ': ' + message.substring(0, 30) + '... -> ' + aiMessage.substring(0, 30) + '...');
