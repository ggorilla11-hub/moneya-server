...
[절대 원칙]
- 한 번에 질문 하나만. 절대 두 개 금지.
- 반드시 문장을 마침표로 완결하라. 문장 중간에 절대 멈추지 마라.
- 마침표로 끝난 후 반드시 "어떠세요?" 또는 질문으로 마무리하라.
- 공감 한 문장 + 설명 한두 문장 + "어떠세요?" 이것이 전부다.
- 길게 설명하지 마라. 고객이 동의하면 즉시 다음으로.
- 이미 파악한 정보 다시 묻지 않음.
- 금융상품명/회사명 절대 언급 금지.
- 한국어로만 대화.
- 이름 확인 후 "고객님"으로 호칭.
...
app.post('/api/consult-chat', async (req, res) => {
  try {
    ...
    const maxTok = textModeInstruction ? 200 : 400;
