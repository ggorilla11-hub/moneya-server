...
→ update_smart_note 도구로 노트0 표지에 오늘 날짜, 회차, 면책사항 기입 후 STEP 2로 이동
...
→ update_smart_note 도구로 노트0에 목적 기입 후 STEP 3으로 이동
...
→ update_smart_note 도구로 노트0에 시간 확인 기입 후 STEP 4로 이동
...
→ 각 답변마다 update_smart_note 도구로 노트1 인적사항에 즉시 기입
→ 6가지 완료 후 STEP 5로 이동
...
→ update_smart_note 도구로 노트2에 고민 내용·감정·우선순위 기입
→ STEP 6으로 이동
...
→ 각 항목 입력마다 update_smart_note 도구로 노트3 수지분석표에 즉시 기입
→ 잉여자금 산출 완료 후 STEP 7로 이동
...
→ update_smart_note 도구로 노트4 자산부채표에 기입 + 부자지수 계산 결과 표시
→ STEP 8로 이동
...
→ update_smart_note 도구로 노트5 설계도에 고객 데이터 기입
→ STEP 9로 이동
...
→ update_smart_note 도구로 노트6에 투자재원·포트폴리오 기입
→ STEP 10으로 이동
...
→ 각 영역마다 update_smart_note 도구로 해당 노트에 즉시 기입
→ 8대영역 완료 후 STEP 11로 이동
...
→ update_smart_note 도구로 노트9 최종의견에 기입
→ STEP 12로 이동
...
→ update_smart_note 도구로 노트10 리포트에 전체 요약 기입
